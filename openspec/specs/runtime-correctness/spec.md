...
Defines correctness requirements for runtime execution of dual-arm sequences, including consistency between the scenario parser and controller, overlap contention handling, and final recommendation reporting.

# controller-emit-instrumentation Specification

## Purpose
TBD - created by archiving change fix-run-controller-stall-and-instrumentation. Update Purpose after archive.
## Requirements

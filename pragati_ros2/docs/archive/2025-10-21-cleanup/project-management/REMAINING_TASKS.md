> **Archived:** 2025-10-21
> **Replaced by:** [TODO_MASTER_CONSOLIDATED.md](../TODO_MASTER_CONSOLIDATED.md)

# Cotton Detection ROS2 - Remaining Tasks

> Note: This list is being consolidated into `docs/TODO_MASTER.md`.
> - For production readiness and validation plan, see `docs/PRODUCTION_READINESS_GAP.md`.
> - For the unified roadmap, see `docs/CONSOLIDATED_ROADMAP.md` (if present).
